...
export default function ProductCategory() {
  ...
  const handleToggle = async (category) => {
    try {
      ...
      const updatedCategories = categories.map(cat => 
        cat.numCat === category.numCat ? updatedCategory : cat
      );
      
      // Mettre à jour l'état local immédiatement
      useProductCategoryStore.setState({ categories: updatedCategories });
      
      // Appeler l'API pour mettre à jour la catégorie
      const result = await updateCategory(category.numCat, updatedCategory);
  ...
  const handleUpdateCategory = async () => {
    ...
    const result = await updateCategory(editingCategory.numCat, editingCategory);
  ...
  const confirmDelete = async () => {
    if (categoryToDelete) {
      const result = await deleteCategory(categoryToDelete.numCat);
  ...
  const refreshCategories = async () => {
    try {
      ...
      useProductCategoryStore.setState({ isLoading: true });
      ...
      {showAddForm ? (
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-lg font-medium">Catégorie de produit</h2>
          </div>
          ...
          <div className="mb-6">
            <h3 className="text-center font-bold text-blue-800 mb-4">AJOUTER UNE NOUVELLE CATÉGORIE DE PRODUITS</h3>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-lg font-medium">Modifier la catégorie de produit</h2>
          </div>
          ...
          <div className="mb-6">
            <h3 className="text-center font-bold text-blue-800 mb-4">MODIFIER LA CATÉGORIE DE PRODUITS</h3>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-4 flex items-center">
            ...
            <h2 className="text-lg font-medium">Liste des catégories de produits</h2>
          </div>
